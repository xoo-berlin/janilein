...
<br/>
<button onclick="sendMessage(document.getElementById('eingabeId').value, document.getElementById('eingabeMsg').value);">senden feld</button>
<button onclick="sendMessage('otto', 'standard');">senden standard</button>
